...
parser.add_argument('-backupstrategy', default='TOR_TO_TOR', help='an all-caps string for the backup strategy to use. (default: TOR_TO_TOR)')
...
if(not args.useconfig):
	...
	elif('LOCAL_ROUTING'==args.backupstrategy):
		cfg.defaultBackupStrategy=BackupStrategy.LOCAL_ROUTING
